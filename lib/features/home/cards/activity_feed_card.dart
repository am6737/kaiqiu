...
class ActivityFeedCard extends StatelessWidget {
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('${item.displayTime}${item.venue != null ? ' · ${item.venue}' : ''}',
        ...
        if (item.hasStats) ...[
          ...
          Row(children: [
            ...
            const SizedBox(width: 5),
            _stat(t, item.playDuration != null ? '${(item.playDuration! / 60).toStringAsFixed(1)}h' : '—', l.home_activity_duration),
          ]),
        ],
        // Tags
  ...
  Widget _stat(AppTokens t, String value, String label) => Expanded(
    child: Container(
      ...
      decoration: BoxDecoration(color: t.elev2, borderRadius: BorderRadius.circular(8)),
      child: Column(children: [
        Text(value, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700,
            fontFamily: t.fontMono, fontFamilyFallback: t.monoFallbacks, color: t.accent)),
