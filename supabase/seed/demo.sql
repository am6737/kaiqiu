...
insert into messages (conv_id, sender_id, body, kind, created_at) values
  ...
  ('44444444-4444-4444-4444-000000000002', '10000000-0000-0000-0000-000000000001',
   '今晚大运公园那场你去不？', 'text', now() - interval '3 hours'),
  ...
  ('44444444-4444-4444-4444-000000000003', null,
   '龙岗村超第 5 轮赛程已公布，请查看最新对阵安排。', 'system', now() - interval '3 days'),
  -- 林帅 DM
  ...
  ('44444444-4444-4444-4444-000000000006', '10000000-0000-0000-0000-000000000006',
   '3点吧 老地方大运公园', 'text', now() - interval '3 hours 30 minutes'),
...
insert into notifications (user_id, type, title, body, icon, route, read, created_at) values
  ...
  ('10000000-0000-0000-0000-000000000001', 'rating',
   '你被评为全场最佳', '龙岗村超 QF 中获得 8.7 均分，142 次评分',
  ...
  ('10000000-0000-0000-0000-000000000001', 'pickup',
   '你报名的约球人满了', '大运公园足球场 · 明天 07:00 · 12/12 已满员',
